...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($email === '' || $password === '') {
        ...
        if ($admin && $admin['role'] !== 'superadmin') {
            $error = "This isn't a superadmin account. Please use the correct portal for your role.";
...
?><!DOCTYPE html><html lang="en"><head>
    ...
    <title>Login - Super Admin Login</title>
    ...
    <div class="login-wrap">
        <div class="login-card">
            ...
            <p style="text-align:center; font-size:12px; color:#888; margin-top:16px;">
                First time? Run <a href="setup-admin.php">setup-admin.php</a> once to create the super admin login.
            </p>
        </div>
    </div></body></html>
