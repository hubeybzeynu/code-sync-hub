...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($email === '' || $password === '') {
        ...
        if ($admin && $admin['role'] !== 'librarian') {
            $error = "This isn't a librarian account. Please use the correct portal for your role.";
...
?><!DOCTYPE html><html lang="en"><head>
    ...
    <title>Login - Librarian Login</title>
